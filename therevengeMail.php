<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $message = trim('SawRoom 2: The Revenge');
        ...
        $subject = "Потвърдена резервация за SawRoom 2: The Revenge";
...
Има нова резервация за SawRoom 2: The Revenge!<br><br> 
...
Успешно резервира час за SawRoom 2: The Revenge на '.$_POST["date"].' в '.$_POST["hour"].' ч.
<br><span style="color: white">Нямаме търпение да те посрещнем с касапските ни инструменти!<br><br></span>
<span style="color: white">Добре е да сте на адреса ни (ул. Граф Игнатиев №5) поне 15 минути преди часа ви.<br></span>
<span style="color: white">И още нещо... SawRoom 2 е доста гадна стая! Успех :)</span>
                        </td>
                    </tr>
                </table>
        </body>
        ...
        // Send the email.
        if (mail($recipient, $subject, $email_content, $email_headers) && mail("contact@sawroom.bg", "SawRoom 2: New Reservation", $email_content_self, $email_headers)) {
